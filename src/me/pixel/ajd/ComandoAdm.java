		...
		Player p = (Player)sender;
			if(cmd.getName().equalsIgnoreCase("ajd")) {
				...
				if(p.hasPermission("kom.staff")) {
					if(args.length == 0) {
						p.sendMessage(" ");
	    			p.sendMessage("§c§l[§6§lK§e§lo§6§lM§c§l] >>§c /ajd zerarajd (zerar rank de ajd)");
	    			p.sendMessage("§c§l[§6§lK§e§lo§6§lM§c§l] >>§c /ajd zerarrpt (zerar perguntas)");
	    			p.sendMessage("§c§l[§6§lK§e§lo§6§lM§c§l] >>§c /darponto <player> (dar 1 ponto ao ajudante)");
	    			p.sendMessage("§c§l[§6§lK§e§lo§6§lM§c§l] >>§c /verpontos (para ver seus pontos)");
	    			p.sendMessage("§c§l[§6§lK§e§lo§6§lM§c§l] >>§c /tirarponto <ajudante> ");
